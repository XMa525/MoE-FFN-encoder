...
bracs_f1 = np.array([0.4994, 0.5868, 0.6926, 0.6780])
parotid_f1 = np.array([0.7950, 0.8508, 0.8598, 0.8070])

# These are standard deviations over seeds
bracs_f1_std = np.array([0.139, 0.129, 0.045, 0.088])
parotid_f1_std = np.array([0.080, 0.087, 0.034, 0.046])
...
default_idx = layers.index("21-22")
...
ax1.set_xlabel("Insertion layers")
...
plt.savefig(
    os.path.join(save_dir, "insertion_layer_f1_with_sem_band.png"),
    dpi=300,
    bbox_inches="tight",
)
