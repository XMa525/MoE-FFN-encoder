...
# =========================
expert_nums = ["3", "4", "5", "6"]
x = np.arange(len(expert_nums))

bracs_f1 = np.array([0.6338, 0.6926, 0.5449, 0.6280])
parotid_f1 = np.array([0.7658, 0.8598, 0.7811, 0.8098])

# These are standard deviations over seeds
bracs_f1_std = np.array([0.062, 0.045, 0.113, 0.053])
parotid_f1_std = np.array([0.037, 0.034, 0.025, 0.057])
...
default_idx = expert_nums.index("4")
...
ax1.set_xticks(x)
ax1.set_xticklabels(expert_nums)
ax1.set_xlabel("Number of routed experts")
...
# Save
# =========================
save_dir = "outputs/expert_number_result"
os.makedirs(save_dir, exist_ok=True)

plt.savefig(
    os.path.join(save_dir, "expert_number_f1_with_sem_band.png"),
    dpi=300,
    bbox_inches="tight",
)
